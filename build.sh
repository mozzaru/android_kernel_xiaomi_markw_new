...
CODENAME="markw"
KERNEL_NAME="fluidKernel"

DEFCONFIG="markw_defconfig"

AnyKernel="https://github.com/mozzaru/anykernel.git"
AnyKernelbranch="fluid-markw"

HOSST="toolchain Buildbot"
USEER="machin"
